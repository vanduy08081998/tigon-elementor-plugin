<?php
namespace ElementorTigonhome\Widgets\Archive_Title;
...
class TH_Archive_Title extends Widget_Base {

	public function get_name() {
		return 'th-arhive-title';
	}
  ...
  //
	...
	public function render_element_header() {
		...
		if( !empty( $settings['_skin'] ) ) {
			$classes .= ' th-archive--' . $settings['_skin'];
		} else {
			$classes .= ' th-archive-title--skin-default';
		}
    ...
    the_archive_title( '<h1 class="th-title th-archive-title">', '</h1>' );
